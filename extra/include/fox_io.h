...
ssize_t fox_dputstr_np(int fd, str2c_t str);
...
ssize_t fox_dputunbr_base(int fd, ullong_t n, str2c_t base) __nonnull;
...
size_t fox_sputchar(str_t s, uchar_t c) __nonnull __const;

// Write c in octal (\xxx) into already allocated s
// Returns number of bytes written (always 4)
size_t fox_sputchar_oct(str_t s, uchar_t c) __nonnull __const;

// Write str into already allocated s
// Returns number of bytes written
size_t fox_sputstr(str_t s, str2c_t str) __nonnull;

// Write str into already allocated s (including non-printables)
// Returns number of bytes written
size_t fox_sputstr_np(str_t s, str2c_t str) __nonnull;

// Write an integer to an already allocated string
// Returns number of bytes written
ssize_t fox_sputnbr(str_t s, llong_t n) __nonnull;

// Write an unsigned integer to an already allocated string
// Returns number of bytes written
size_t fox_sputunbr(str_t s, llong_t n) __nonnull;
...
ssize_t fox_sputunbr_base(str_t s, ullong_t n, str2c_t base) __nonnull;

// Allocate s and print c into it
// Returns -1 in case of failed allocation
ssize_t fox_asputchar(str_t *s, char c) __nonnull;

// Allocate s and print c in octal (\xxx) into it
// Returns -1 in case of failed allocation
ssize_t fox_asputchar_oct(str_t *s, uchar_t c) __nonnull;

// Allocate s and print str into it
// Returns -1 in case of failed allocation
ssize_t fox_asputstr(str_t *s, str2c_t str) __a((nonnull(1)));

// Allocate s and print str (including non-printables) into it
// Returns -1 in case of failed allocation
ssize_t fox_asputstr_np(str_t *s, str2c_t str) __a((nonnull(1)));

// Allocate s and print n (signed) into it
// Returns -1 in case of failed allocation
ssize_t fox_asputnbr(str_t *s, llong_t n) __nonnull;

// Allocate s and print n (unsigned) into it
// Returns -1 in case of failed allocation
ssize_t fox_asputunbr(str_t *s, ullong_t n) __nonnull;

// Allocate s and print n in given base into it
// Returns -1 in case of failed allocation
ssize_t fox_asputunbr_base(str_t *s, ullong_t n, str2c_t base) __nonnull;
